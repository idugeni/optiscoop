...
export default function HeroSection() {
  return (
    <section className="relative text-center space-y-8 py-6">
      ...
      <div 
        className="flex justify-center mb-8 animate-in fade-in zoom-in-95 duration-500"
      >
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
        <h1 
          className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/70 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100"
        >
          Dukung OptiScoop
        </h1>
        
        <p 
          className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200"
        >
        ...
        <div 
          className="flex justify-center gap-2 pt-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300"
        >
